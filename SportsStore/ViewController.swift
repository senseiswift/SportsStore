...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    var products = [
        ...
        Product(name:"Corner Flags", description:"Give your playing field a professional touch", category:"Soccer", price:19.5, stockLevel:1),
    ...
    func displayStockTotal() {
        let finalTotals:(Int, Double) = products.reduce((0, 0.0), combine: {(totals, product) -> (Int, Double) in return (
